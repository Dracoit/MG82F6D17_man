...
///***********************************************************************************
//Function:   void ADC_StopChannelScan(void)
//Description:   
//Input:   
//Output:     
//*************************************************************************************/
...
///***********************************************************************************
//Function:   void ADC_StartDMAChannelScan(void)
//Description:   
//Input:   
//Output:     
//*************************************************************************************/
void ADC_StartDMAChannelScan(void)
{
	ADC_ClrInterruptFlag();
	ADC_SetChannel_AIN2();
	ADC_SetChannelAutoScan(BIT0|BIT1|BIT5); 		// ADC Channel scan: AIN2,AIN3,AIN5
	ADC_SetMode_FreeRunning();						// ADC mode
	DMA_Start();
	ADC_SoftStart();
}
