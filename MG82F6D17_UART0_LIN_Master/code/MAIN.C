	...
	else
	{
		...
		{// Send PID end 
			if(LINFrame.Mode == LIN_MODE_MASTER_RX)
			{
				...
				UART0_LIN_SetRX();			// set UART0 to IN RX mode
...
void InitUart0_LIN(void)
{
	...
	UART0_LIN_TxSYNC_16Bit();			// Set LIN TX break 16bit
...
///***********************************************************************************
//Function:   	void LIN_Master_StartFrame(void)
//Description:   	LIN Master start frame
//Input:   
//Output:     
//*************************************************************************************/
void LIN_Master_StartFrame(void)
...
///***********************************************************************************
//Function:		void TestMasterTxMsgToSlave()
//Description: 	Test transmit data to slave
//Input:	
//Output:	  
//*************************************************************************************/
void TestMasterTxMsgToSlave()
{
	...
	INT_DisUART0();						// Disable UART0 interrupt
...
///***********************************************************************************
//Function:		void TestMasterRxMsgFromSlave()
//Description: 	Test receive data from slave
//Input:	
//Output:	  
//*************************************************************************************/
