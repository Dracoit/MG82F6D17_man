...
//			CpuCLK=110592MHz, SysCLK=11.0592MHz
//	Description:
//			KBI Wakup
//			Enter Power down mode, wake up by KBI;
//	Note:
//
//    Creat time::
//    Modify::
...
void InitPort(void)
{
	...
	PORT_SetP1OpenDrainPu(BIT0|BIT1);					// set P10,P11 as open-drain with pull-high for KBI
}
...
void InitKBI(void)
{
	...
	KBI_SetDetectLevel();					// KBI Edge mode: level detection
