...
//		Description:
//			T2 mode: Auto-Reload with External Interrupt,clock source:Sysclk/12	
//			T3 mode: Auto-Reload with External Interrupt,clock source:Sysclk/12  
//		Note:
//
//    Creat time::
//    Modify::
...
{
	TM_SetT2Mode_AutoRLwithExI();			// T2 mode: Auto-Reload with External Interrupt
...
{
	TM_SetT3Mode_AutoRLwithExI();			// T3 mode: Auto-Reload with External Interrupt
	TM_SetT3Clock_SYSCLKDiv12();			// T3 clock source: SYSCLK/12

	TM_SetT3LowByte(0);						// T3 low byte
	TM_SetT3HighByte(0);					// T3 high byte
	TM_SetT3RLHighByte(0);					// T3 reload high byte
	TM_SetT3RLLowByte(0);					// T3 reload low byte
	
	TM_SetT3Capture_P60();					// T3 EXI:P60
	TM_EnableT3EX_DetectFalling();			// T3 detect: Falling
