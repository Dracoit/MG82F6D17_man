...
//	Description:
//			CH0,CH2 Output CEX0(P22),CEX2(P24)
//	Note:
//
//    Creat time::
//    Modify::
...
void InitPort(void)
{
	...
	PORT_SetP2PushPull(BIT2|BIT4);						// set P22,P24 as push-pull for output
}


///***********************************************************************************
//Function:   	void InitPCA_HighSpeed(void)
//Description:    Initialize PCA for High speed output
//Input:   
//Output:     
//*************************************************************************************/
void InitPCA_HighSpeed(void)
{
	PCA_SetCLOCK_SYSCLK();							// PCA clock: SysClk
	
	PCA_CH0_SetMode_16BitHighSpeedOutput();			// set CH0 for high speed output
	PCA_CH2_SetMode_16BitHighSpeedOutput();			// set CH2 for high speed output
	
	PCA_SetCounter(0);
	PCA_SetCounterReload(0);

	PCA_CH0_SetValue_L(0x00);
	PCA_CH0_SetValue_H(0x40);

	PCA_CH2_SetValue_L(0x00);
	PCA_CH2_SetValue_H(0x8);
