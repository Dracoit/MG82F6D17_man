...
//			Edge,8bit 256
//			PWM Freq: PCAClk/(256)=12MHz/256=46.875KHz
//	Note£º
//
//    Creat time::
//    Modify::
...
{
	PCA_SetCLOCK_SYSCLK();			// PCAClock is SysClk = 12MHz
	...
	PCA_CH0_SetValue_H(0);				// Relaod value
	PCA_CH0_SetValue_9thBit_H_0();		// 9th bit

	PCA_CH1_SetValue_L(0); 				
	PCA_CH1_SetValue_9thBit_L_0();		// 9th bit
	PCA_CH1_SetValue_H(0);				// Relaod value
	PCA_CH1_SetValue_9thBit_H_0();		// 9th bit

	PCA_CH2_SetValue_L(0); 				
	PCA_CH2_SetValue_9thBit_L_0();		// 9th bit
	PCA_CH2_SetValue_H(0);				// Relaod value
	PCA_CH2_SetValue_9thBit_H_0();		// 9th bit

	PCA_CH3_SetValue_L(0); 				
	PCA_CH3_SetValue_9thBit_L_0();		// 9th bit 
	PCA_CH3_SetValue_H(0);				// Relaod value
	PCA_CH3_SetValue_9thBit_H_0();		// 9th bit

	PCA_CH4_SetValue_L(0); 				
	PCA_CH4_SetValue_9thBit_L_0();		// 9th bit
	PCA_CH4_SetValue_H(0);				// Relaod value
	PCA_CH4_SetValue_9thBit_H_0();		// 9th bit

	PCA_CH5_SetValue_L(0); 				
	PCA_CH5_SetValue_9thBit_L_0();		// 9th bit
	PCA_CH5_SetValue_H(0);				// Relaod value
	PCA_CH5_SetValue_9thBit_H_0();		// 9th bit

	PCA_CH6_SetValue_L(0); 				
	PCA_CH6_SetValue_9thBit_L_0();		// 9th bit
	PCA_CH6_SetValue_H(0);				// Relaod value
	PCA_CH6_SetValue_9thBit_H_0();		// 9th bit
	
	PCA_CH7_SetValue_L(0); 				
	PCA_CH7_SetValue_9thBit_L_0();		// 9th bit
	PCA_CH7_SetValue_H(0);				// Relaod value
	PCA_CH7_SetValue_9thBit_H_0();		// 9th bit
...
void main()
{
	...
	while(1)
    {
		...
		PCA_CH6_SetValue_8Bit(wDuty[6].B.BHigh,wDuty[6].B.BLow);
		PCA_CH7_SetValue_8Bit(wDuty[7].B.BHigh,wDuty[7].B.BLow);
    }
}
