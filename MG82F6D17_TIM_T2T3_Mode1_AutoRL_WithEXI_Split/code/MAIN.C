...
//		Description:
//			Split T2 mode: Auto-Reload with External Interrupt,clock source:Sysclk/12	
//			Split T3 mode: Auto-Reload with External Interrupt,clock source:Sysclk/12  
//		Note:
//
//    Creat time::
//    Modify::
...
{
	TM_SetT2Mode_AutoRLwithExI();			// T3 mode: Auto-Reload with External Interrupt
