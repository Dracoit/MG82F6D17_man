...
//		Description:
//			T0 mode: 8bit timer with auto reload,clock source: Sysclk/192	
//			T1 mode: 8bit timer with auto reload,clock source: Sysclk/48
//		Note:
//
//    Creat time::
//    Modify::
...
void InitTimer0(void)
{
	...
	TM_SetT0HighByte(200);					// Set TH0 value for reload
...
{
	TM_SetT1Mode_2_8BIT_AUTORELOAD();		// TIMER1 Mode:8bit timer with auto reload
	TM_SetT1Clock_SYSCLKDiv48();			// TIMER1 Clock source: SYSCLK/48
	TM_SetT1Gate_Disable();					// TIMER1 disable gate

	TM_SetT1LowByte(0);						// Set TL1 value
	TM_SetT1HighByte(100);					// Set TH1 value for reload
