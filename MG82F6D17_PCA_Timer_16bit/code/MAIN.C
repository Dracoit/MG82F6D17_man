...
///***********************************************************************************
//Function:   	void InitPCA_SoftwareTimer(void)
//Description:	Initialize PCA for 16bit Software Timer
//Input:   
//Output:   		
//*************************************************************************************/
void InitPCA_SoftwareTimer(void)
{
	...
	PCA_CH0_SetValue_L(LOBYTE(2000));
	PCA_CH0_SetValue_H(HIBYTE(2000));

	PCA_CH2_SetValue_L(LOBYTE(4000));
